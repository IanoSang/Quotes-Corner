...
export class QuotesComponent implements OnInit {
  quotes:Quotes[] = [
    ...
    new Quotes(2, 'It\'s really that simple: Program, or be programmed', 'By Software Dev', 'Ian Sang', '0', '0',),
    ...
    new Quotes(4, 'The way to get started is to quit talking and begin doing', 'By Someone', 'Ian Sang', '0', '0'),
    new Quotes(5, 'Furaha sio kitu kilichoundwa tayari. Inakuja kutoka kwa matendo yako.', 'Swahili Quote', 'Ian Sang', '0', '0'),
    new Quotes(6, 'We live in a country where our young ladies who have recently attained the age of puberty cannot afford sanitary pads, but our men and women in public offices have iPads which they do not even know how to use.', 'By Patrick Lumumba', 'Ian Sang', '0', '0'),
  ];
